...
{
    public partial class Ingredients : MetroFramework.Forms.MetroForm
    {
        ...
        public void GetListUsers()
        {
            ...
            string commandStr = "SELECT id_Ingredient AS 'Код',Ingredient AS 'Ингредиент',Price AS 'Цена' FROM T_ingredient";
